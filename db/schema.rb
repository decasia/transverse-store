...
ActiveRecord::Schema.define(version: 20170103192839) do
  ...
  create_table "doc_versions", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer  "doc_id"
    t.integer  "user_id"
    t.integer  "group_id"
    ...
    t.datetime "created_at",               null: false
    t.datetime "updated_at",               null: false
    t.index ["doc_id"], name: "index_doc_versions_on_doc_id", using: :btree
    t.index ["group_id"], name: "index_doc_versions_on_group_id", using: :btree
    t.index ["user_id"], name: "index_doc_versions_on_user_id", using: :btree
  end
